...
if mode == "identify the position":
    ...
    # Replace the 3 example lines below with your full list (one voicing per line):
    # Format: <Chord Name>: <note> <note> <note> [<note>]
    RAW_VOICINGS = """
    ...
    # Parse the pasted list into a dict
    def parse_voicings(raw: str):
        voicings = {}
